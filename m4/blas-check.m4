## Copied (with minor modifications) from linbox/macros (using Linbox version 1.1.6) 
...
## Added by PAS for compatibility 
OLD_CXXFLAGS=${CXXFLAGS}
CXXFLAGS="${LINBOX_CPPFLAGS} ${CXXFLAGS}"
